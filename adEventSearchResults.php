 ...
 .jumbotron .container {
   ...
   textarea:focus {
	...
	function evaluateSelection(i) {
		...
		var code = document.getElementById("adEventCode").value = insertCode;
	}
																...
																<?php
																	...
																	while($row = mysql_fetch_row($data)) {
																		...
																		if(grab_linked_promotions_to_ad($promo_link) != "no") {
																			echo "<td><button style='padding: 10px 10px;' onclick='evaluateSelection($adjust)' type='button' class='btn btn-primary' data-toggle='modal' data-target='#selectLinkedItems'><span class='glyphicon glyphicon-minus'></span></button></td>";
																		}
																		echo "</tr>";
																	}
				...
				<div class='modal-dialog' role='document'>
					<div class='modal-content'>
						...
						<!-- Hidden but links to what itemcode/row was clicked -->
							<input class='form-control' placeholder='' name='adEventCode' id='adEventCode' type='hidden' readonly>
							<center>
							...
							<!-- Listing Search -->";
																				...
																				ob_end_flush();
																				echo "$output";
																				$item_Data = grab_linked_promotions_to_ad($output);
																				echo "<thead><tr>";
