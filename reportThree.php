...
<head>
	...
	<title>Josbrian Interface - Report Three</title>
  <script>
    function printData()
    {
	...
	<div id="wrapper">
		...
		<nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <div id="left-sidebar" class="sidebar">
                <ul id="main-menu" class="metismenu">
                  ...
                  <li name="thirdReport" id="thirdReport" class="active"><a href="reports.php">Third Report</a></li>
                  <li name="fourthReport" id="fourthReport"><a href="reports.php">Fourth Report</a></li>
                </ul>
              </div>
              </div>
		</nav>
     ...
     <!--  TABLE TO RETURN DATA TO  -->
                        ...
                        <div id="searchResults" class="container">
                         <div class="jumbotron">
                            <h2 style="padding-bottom: 20px; text-align: left"><b>Report Three Results:</b></h2>
                            ...
                            <table class="table" id="printTable">
														<!-- Listing Search -->
																<?php
																	...
																	$data = report_by_item($_POST['itemNumber'], $_POST['description'], $_POST['category'], $_POST['department']);
																	echo "<thead><tr>";
