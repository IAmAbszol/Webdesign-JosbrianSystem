...
<head>
	...
	<title>Josbrian Interface - Report One</title>
  <script>
    function printData()
    {
	...
	<div id="wrapper">
		...
		<nav id="left-sidebar-nav" class="sidebar-nav">
            ...
            <div id="left-sidebar" class="sidebar">
                <ul id="main-menu" class="metismenu">
                  ...
                  <li name="firstReport" id="firstReport" class="active"><a href="reports.php">First Report</a></li>
     ...
     <!--  TABLE TO RETURN DATA TO  -->
                        ...
                        <div id="searchResults" class="container">
                         <div class="jumbotron">
                            <h2 style="padding-bottom: 20px; text-align: left"><b>Report One Results:</b></h2>
                            ...
                            <table class="table" id="printTable">
                                  ...
                                  $tmp = $_POST['adEventstart'];
																	$data = report_by_date($tmp);
																	echo "<thead><tr>";
